...
class CustomRBFFeedForward(nn.Module):
    def __init__(self, in_features, out_features, num_kernels, kernel_name='gaussian'):
        ...
        self.rbf_layer = RBFLayer(
            ...
            radial_function=rbf_gaussian if kernel_name == 'gaussian' else  multiquadric_kernel,  # Use the Gaussian RBF
